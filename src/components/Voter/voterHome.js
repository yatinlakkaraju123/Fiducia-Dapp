import VoterNavbar from '../navbars/VoterNavbar.jsx';
            ...
            <div className="flex flex-col self-stretch my-auto max-md:mt-10 max-md:max-w-full">
              <div className="flex flex-col ml-28 max-w-full capitalize w-[610px]">
                ...
                <div className="mt-4 ml-9 text-lg text-zinc-700 max-md:max-w-full">
                 YOu can register,cast your vote and view voting results regarding the voting application. For feedback application you can register and give your feedback
                </div>
              </div>{" "}
